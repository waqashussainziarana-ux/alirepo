  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-xl shadow-lg p-8">
        ...
        <form onSubmit={view === 'login' ? handleLoginSubmit : handleSignupSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full mt-6 text-sm text-slate-500 hover:text-primary transition-colors font-medium"
        >
